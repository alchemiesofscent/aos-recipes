# Quantity normalization pass — 2026-05-28
...
- Rule 1 γο → uncia: filled **1**, corrected **19** entries.
- Rule 1b ξε → xestes: filled **0**, corrected **0** entries.
- Rule 1c λι → litra: filled **3**, corrected **1** entries.
...
- Canonical files rewritten: **11**.
- Provenance mirrors rewritten: **11**.
