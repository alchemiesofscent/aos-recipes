# Quantity normalization pass — 2026-06-05
...
- Rule 1 γο → uncia: filled **75**, corrected **29** entries.
- Rule 1b ξε → xestes: filled **1**, corrected **0** entries.
- Rule 1c λι → litra: filled **28**, corrected **7** entries.
...
- Canonical files rewritten: **69**.
- Provenance mirrors rewritten: **65**.
